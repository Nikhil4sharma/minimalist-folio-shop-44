            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {categories.map((category, index) => (
                <Link 
                  ...
                  key={category.name}
                  className="group relative overflow-hidden rounded-xl aspect-square glass dark:glass-dark hover:scale-[1.02] transition-transform duration-300 animate-fade-in"
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div 
                  key={feature.title}
                  className="bg-navy-light p-6 rounded-xl border border-white/10 text-center animate-fade-in"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
